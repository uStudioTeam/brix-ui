...
import { isOptionSelected } from './radio-group.module';
        ...
        <Styled.RadioGroupItem key={option.value} $classNames={classNames} $styled={styled}>
          ...
          >
            <Styled.Input
              ...
              name={name}
              value={option.value}
              defaultChecked={isOptionSelected({ option, value: internalValue })}
              onChange={() => {
              ...
              aria-checked={isOptionSelected({ option, value: internalValue })}
