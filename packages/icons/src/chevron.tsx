...
const Chevron = intrinsicComponent<IconProps, SVGSVGElement>(function Chevron(props, ref) {
  return (
    <svg ref={ref} viewBox="0 0 10 6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
